...
const zhCn: Dictionary = {
  ...
  triggerPromptPermission: "请运行一个会触发权限确认的只读命令（例如列出当前目录之外的某个目录），并在权限弹窗中选择允许",
...
const en: Dictionary = {
  ...
  triggerPromptPermission: "Run any read-only command that needs approval (e.g. list a directory outside this project) and approve the prompt",
